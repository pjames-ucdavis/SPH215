...
Next, we want to read in all of our spatial data. First, we read in the *CAdata* dataset, and then convert it to a spatial dataset. 
...
ca_transformed <- st_transform(cancer_points_crs, st_crs(walkability_tracts))  
