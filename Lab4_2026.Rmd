...
Use the `set_acs()` command to bring in California tract-level race/ethnicity counts, total population, and total number of households. How did I find the variable IDs? Check [Lab 3](Lab3_2026.html). Since we want tracts, we’ll use the `geography = "tract"` argument.
```{r, results=FALSE}
