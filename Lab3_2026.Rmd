...
We learned about the various data wrangling related functions from the **tidyverse** package in [Lab 1](Lab1_2026.html). Let’s employ some of those functions to create a single county level dataset that joins the datasets we downloaded from the Census API and PolicyMap.
