---
title: 'Lab 3: Geocoding, Vector Data, and Census Data'
---
...
As you learned in [Lab 1](Lab1_2026.html) and [Lab 2](Lab2_2026.html), whenever you bring in a dataset, the first thing you should always do is view it to get a sense of its structure and to make sure you got what you expected. One way of doing this is to use the `glimpse()` command
...
We learned about the various data wrangling related functions from the **tidyverse** package in [Lab 2](Lab2_2026.html). Let’s employ some of those functions to create a single county level dataset that joins the datasets we downloaded from the Census API and PolicyMap.
...
```{r}
write_csv(cacounty, "lab3_file.csv")
```
