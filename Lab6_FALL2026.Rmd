...
First, let's set this up to be centered around the building we all know and love, the one that we are in right now. That's right--Giedt Hall. I've clearly memorized the longitude and latitude for this building, which we paste in below, and then store as an **sf** object.
```{r}
loc <- c("lon" = -121.75584, "lat" = 38.53766)
loc_sf <- st_sf(name = "Giedt Hall",
