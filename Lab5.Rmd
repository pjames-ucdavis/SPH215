...
The objectives of this guide are to teach you:
   ...
   2. Import a dataset with greenspace across California
...
## Read in Light at Night Data

We then read in the raster for light at night data across California. Finally, we check the file to make sure it was read correctly. Does it have a coordinate reference system?
