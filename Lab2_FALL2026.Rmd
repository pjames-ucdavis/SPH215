...
So let's bring in the *CAdata* dataset and have a look at it. We don't have to do much because it's part of the **MapGAM** package and quickly loads in with the `data()` command.
